...
public class BasicoFactory extends ProgramaFactory {
    @Override
    public Programa crearPrograma(String codigo, String nombre, String idioma, String descripcion,
        ...
        return new ProgramaBasico(codigo, nombre, idioma, descripcion, duracionMeses, valorMensual, estado, modalidad, cupos);
    }
}